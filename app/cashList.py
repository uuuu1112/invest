...
from app.base import Cash,SeasonEps,YearEps,SeasonEpsLoseExtraEarn,YearEpsLoseExtraEarn,CashLoseExtraEarn
...
class CashList(CashLoseExtraEarn):
    def __init__(self, loseExtra=None):
        super().__init__(loseExtra)
    def latestCash(self):
